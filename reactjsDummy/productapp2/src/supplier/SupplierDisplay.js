...
import { startCreatingSupplier } from "../store/actionCreators/stateActionsCreators";
...
const connectFuntion = connect(mapStateToProps, mapDispatchToProps);

export const SupplierDisplay = connectFuntion(
