...
exports.author_delete_get = function(req, res,next) {
    ...
    async.parallel({
        ...
        res.render('author/author_delete', {title: 'Delete Author',author:result.author, author_books:result.booksList});
    });
};
